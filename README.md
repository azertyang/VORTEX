...
fine-tuning, reducing trainable parameters to under 1.4\% of the backbone, and we explicitly evaluate cross-technology generalisation by transferring zero-shot from CosMx to MERFISH. 
